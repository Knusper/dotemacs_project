...
** Init file
   ...
   #+BEGIN_SRC emacs-lisp :tangle no
     ...
     ;; org-mode
     (add-to-list 'load-path (expand-file-name "~/emacs-scripts/org-9.0.7/lisp/"))
     (add-to-list 'load-path "~/emacs-scripts/org-9.0.7/contrib/lisp" t)
     (eval-after-load "info"
       '(progn
	  (info-initialize)
	  (add-to-list 'Info-directory-list "~/emacs-scripts/org-9.0.7/doc/")))
...
*** Org-Mode
    ...
    #+BEGIN_SRC emacs-lisp :tangle yes
      ...
      ;; I need these keys for something else
      (eval-after-load 'org
	(progn
      ...
      ;; intedentation needs to be preserved, otherwise tangled python3
      ;; source blocks from org-mode files will not run
...
=======
	 (use-package zenburn-theme
	   ...
	   :config
	   (load-theme 'zenburn))
>>>>>>> 99ee2f4ac113d0617dc690f5684abd181e67592c
       #+END_SRC
